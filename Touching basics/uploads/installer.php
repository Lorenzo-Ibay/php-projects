...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230130_abodelandscaping_fca9540473c418c37363_20230130042744_archive.zip';
        const ARCHIVE_SIZE       = '323010153';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'fca9540-30042744';
        const SECONDARY_PACKAGE_HASH = 'ef5112a-30042744';
        const VERSION            = '1.5.2';
